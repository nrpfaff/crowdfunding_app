...
console.log(this.today);*/
  ...
  console.log(projects);
    ...
    console.log(projects, this.title, this.description, this.category, this.fundedAmount, this.fundsNeeded, this.startDate, this.endDate);
  ...
  projectsize(){
      this.apiService.getprojects().subscribe( response => {
        ...
        localStorage.setItem('page_id', response.data.length);
